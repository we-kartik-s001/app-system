            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    ...
                    <Button label="Edit"
                            ...
                            data-testid="doctorsappointments-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button
                        ...
                        data-testid="doctorsappointments-item-menu"
                    ...
                    <Button class="p-button-primary p-button-sm"
                            icon="pi pi-times"
                            data-testid="doctorsappointments-item-to-list"
                            @click="store.toList()"/>
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="ml-3">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="doctorsappointments-item-restore"

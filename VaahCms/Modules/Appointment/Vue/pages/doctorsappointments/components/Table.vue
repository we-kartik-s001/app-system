...
<!--            </Column>-->
            ...
            <Column field="title" header="Title"
             ...
             <Column field="start_time" header="Start Time"
                 ...
                 <template #body="prop">
                     {{useVaah.strToSlug(prop.data.start_time)}}
                 </template>
             ...
             <Column field="end_time" header="End Time"
                 ...
                 <template #body="prop">
                     {{useVaah.strToSlug(prop.data.end_time)}}
                 </template>
            ...
            <Column field="is_active" v-if="store.isViewLarge()"
                ...
                <template #body="prop">
                    <InputSwitch v-model.bool="prop.data.status"
                                 data-testid="doctorsappointments-table-is_active"
                ...
                <template #body="prop">
                    <div class="p-inputgroup ">
                        ...
                        <Button class="p-button-tiny p-button-text"
                                data-testid="doctorsappointments-table-to-view"
                                v-tooltip.top="'View'"
                                @click="store.toView(prop.data)"
                                icon="pi pi-eye" />

                        <Button class="p-button-tiny p-button-text"
                                data-testid="doctorsappointments-table-to-edit"
                                v-tooltip.top="'Update'"
                                @click="store.toEdit(prop.data)"
                                icon="pi pi-pencil" />

                        <Button class="p-button-tiny p-button-danger p-button-text"
                                data-testid="doctorsappointments-table-action-trash"
                        ...
                        <Button class="p-button-tiny p-button-success p-button-text"
                                data-testid="doctorsappointments-table-action-restore"
                                v-if="store.isViewLarge() && prop.data.deleted_at"
